...
namespace HospitalNet.Backend.BusinessLogic
{
    ...
    public class PerformanceReport
    {
        ...
        {
            return $"Performance report for {StartDate:yyyy-MM-dd} to {EndDate:yyyy-MM-dd}: " +
                   $"Total Appointments: {AppointmentStats.TotalAppointments}, " +
                   $"Completed: {AppointmentStats.CompletedAppointments}, " +
                   $"Cancelled: {AppointmentStats.CancelledAppointments}, " +
                   $"No-Shows: {AppointmentStats.NoShowAppointments}";
        }
    }
